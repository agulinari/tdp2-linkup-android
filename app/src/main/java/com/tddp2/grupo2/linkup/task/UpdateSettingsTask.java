...
public class UpdateSettingsTask extends AsyncTask<Object, Void, TaskResponse> {

    private ProfileService profileService;
    private SettingsController controller;

    public UpdateSettingsTask(ProfileService profileService, SettingsController controller) {
